...
export default function Services() {
  ...
  return (
    <>
      ...
      <section
        className={`relative h-screen transition-opacity duration-700 bg-[url('https://img.freepik.com/free-photo/young-employees-sitting-office-table-using-laptop-team-work-brainstorming-meeting-concept_146671-15628.jpg?t=st=1741126816~exp=1741130416~hmac=4332d2c8c1cbaabe46ec42fbcb87c145345a40b6ee82db625138474984efd452&w=1380')] bg-cover text-white flex justify-center items-center`}
      >
